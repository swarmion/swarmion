import { getTrigger as getApiGatewayTrigger } from 'contracts/apiGateway/features';
import { getTrigger as getEventBridgeTrigger } from 'contracts/eventBridge/features';
