...
import { getApiGatewayHandler } from '../features/lambdaHandler';
...
describe('apiGateway lambda handler', () => {
  describe('httpApi, with authorizer, when all parameters are set', () => {
    ...
    it('should return a 200 response', async () => {
      ...
      const httpHandler = getApiGatewayHandler(httpApiContract)(
        async ({
          body,
          pathParameters,
    ...
    it('should work well with middified handler (cors)', async () => {
      ...
      const handler = getApiGatewayHandler(httpApiContract)(
        async ({
          body,
          pathParameters,
          queryStringParameters,
  ...
  describe('restApi, without authorizer, with subset of parameters', () => {
    it('should return a 200 response', async () => {
      ...
      // TODO fix me
      // @ts-expect-error we don't know what is happening here
      const httpHandler = getApiGatewayHandler(restApiContract)(handler);
